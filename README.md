...
An optional `nextOpponent` string can be set on a still-advancing team to show a real name in the Knockout card's "NEXT" chip; when absent (the current state for every team — nothing populates this yet) it shows "TBD".
